#############################################################################
# Makefile for building: faggotcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sun Feb 11 06:34:40 2018
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /root/faggotcoin/src/leveldb/libleveldb.a /root/faggotcoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
/root/faggotcoin/src/leveldb/libleveldb.a: FORCE
	cd /root/faggotcoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/root/faggotcoin/build/build.h: FORCE
	cd /root/faggotcoin; /bin/sh share/genbuild.sh /root/faggotcoin/build/build.h
